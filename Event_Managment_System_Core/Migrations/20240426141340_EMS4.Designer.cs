            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 13, 40, 298, DateTimeKind.Local).AddTicks(6229));
                    ...
                    b.ToTable("Bookings", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("Ch_PromoCode", "len(romoCode)<=6");
                        });
                });
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 13, 40, 298, DateTimeKind.Local).AddTicks(8723));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 13, 40, 299, DateTimeKind.Local).AddTicks(9026));
