...
namespace Event_Managment_System_Core.Migrations
{
    ...
    partial class EventManagemntSystemContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 18, 4, 11, 469, DateTimeKind.Local).AddTicks(6798));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 18, 4, 11, 469, DateTimeKind.Local).AddTicks(9306));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 18, 4, 11, 470, DateTimeKind.Local).AddTicks(9708));
