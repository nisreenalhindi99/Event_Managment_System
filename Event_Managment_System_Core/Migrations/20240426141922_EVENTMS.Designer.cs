...
namespace Event_Managment_System_Core.Migrations
{
    ...
    [Migration("20240426141922_EVENTMS")]
    partial class EVENTMS
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 19, 22, 568, DateTimeKind.Local).AddTicks(1588));
                    ...
                    b.ToTable("Bookings", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("Ch_Booking_PromoCode", "len(romoCode)<=6");
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 19, 22, 568, DateTimeKind.Local).AddTicks(3909));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 19, 22, 569, DateTimeKind.Local).AddTicks(3590));
