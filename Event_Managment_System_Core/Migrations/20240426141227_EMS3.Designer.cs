            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 12, 27, 98, DateTimeKind.Local).AddTicks(7125));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 12, 27, 98, DateTimeKind.Local).AddTicks(9263));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 12, 27, 99, DateTimeKind.Local).AddTicks(2985));
