            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 8, 58, 701, DateTimeKind.Local).AddTicks(764));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 8, 58, 701, DateTimeKind.Local).AddTicks(3078));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 8, 58, 701, DateTimeKind.Local).AddTicks(7275));
