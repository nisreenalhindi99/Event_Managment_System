            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Booking", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 30, 29, 395, DateTimeKind.Local).AddTicks(4167));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 30, 29, 395, DateTimeKind.Local).AddTicks(6356));
            ...
            modelBuilder.Entity("Event_Managment_System_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 4, 26, 17, 30, 29, 396, DateTimeKind.Local).AddTicks(5884));
